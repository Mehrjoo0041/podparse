...
import { fetchAdminEpisodes, submitTranslation, retryEpisode, type Episode } from '../../api/client';
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-stone-900">اپیزودها</h1>
        <Link to="/panel/add"
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="text-right text-xs font-medium text-stone-500 uppercase tracking-wide bg-stone-50">
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 p-4 animate-fade-in">
          <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[80vh] flex flex-col animate-scale-in">
            ...
            <div className="px-6 py-4 border-t border-stone-100 flex justify-start gap-3">
              ...
              <button onClick={() => setTranslationModal(null)} className="px-4 py-2 text-sm text-stone-600">انصراف</button>
            </div>
          </div>
        </div>
      )}
